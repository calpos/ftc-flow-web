...
/** Hold time per word in the rotating hero headline, in ms. */
export const ROTATE_HOLD = 2600;

/** Duration of the rotating word's roll transition, in seconds. */
export const ROTATE_DURATION = 0.5;
